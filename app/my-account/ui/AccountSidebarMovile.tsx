...
const AccountSidebarMovile = ({  className}: Props) => {
                ...
                {links.map(item => {
                    ...
                    return (
                        <Link
                            className={
                                clsx(
                                    "flex items-center bg-white gap-4 w-full hover:bg-[#C4C4C4] hover:cursor-pointer p-3 text-black",
                                    {
...
export default AccountSidebarMovile